...
Plans:
- [x] 03-01-PLAN.md - Extract filter terms to JSON configuration file (ARCH-01)
- [x] 03-02-PLAN.md - Implement weighted scoring engine with ScoringResult (ARCH-02, ARCH-04)
- [x] 03-03-PLAN.md - Separate company and role classification (ARCH-03)
